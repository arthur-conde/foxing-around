exports.run = (client, message, [mention, ...reason]) => {
  ...
  if (!message.guild.me.hasPermission("KICK_MEMBERS")) {
    message.channel.send({embed:{color: message.guild.me.displayColor, description:`:x: Sorry <@${message.member.id}>, I don't have the permissions to do that`}}).then( message => {
